...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  imageplaque = GTK_WIDGET(gtk_builder_get_object(builder, "imageplaque"));
  ...
  g_signal_connect(load, "clicked", G_CALLBACK(on_load), window);
  //g_signal_connect(load, "clicked", G_CALLBACK(on_load_clicked), window);
